...
import { Project, PricingStrategy } from '../../types';
import { X, CheckCircle2, Calculator, Plus, Image as ImageIcon } from 'lucide-react';
...
interface ProjectDetailsModalProps {
  ...
  updateFinancials: (id: string, financials: Project['financials']) => void;
  handleGenerateInvoice: (project: Project) => void;
  addProjectImage: (id: string, url: string) => void;
  removeProjectImage: (id: string, url: string) => void;
  PRICING_STRATEGIES: { id: PricingStrategy; desc: string }[];
}
