...
export default function Invoice({ project, customer, inventoryItem }: InvoiceProps) {
  return (
    <div className="p-8 bg-white text-stone-900 max-w-2xl mx-auto border border-stone-200">
      <div className="flex justify-between mb-8">
        <div>
          <h1 className="text-3xl font-serif italic font-bold">{project.brand}</h1>
          <p className="text-sm text-stone-500">Invoice #{project.id?.slice(-6).toUpperCase()}</p>
        </div>
      ...
      <div className="mb-8">
        <h2 className="text-sm font-bold uppercase text-stone-400 mb-2">Bill To</h2>
